...
public class BodyFormInputPanel extends JPanel implements DocumentListener {
    ...
    public void checkType() {
        System.out.println("checkType -> setEnabled");
        System.out.println("checkType -> FILE");
        System.out.println("checkType -> FILE");
        System.out.println("checkType -> getName");
        System.out.println("checkType -> getName");
        System.out.println("checkType -> getSelectedItem");
        ...
        if (valueField != null) {
            System.out.println("checkType -> setEditable");
            System.out.println("checkType -> setText");
    ...
    public void remove() {
        ...
        System.out.println("remove -> updateUI");
