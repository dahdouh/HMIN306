...
public class SocketIoPanel extends JPanel {
    ...
    public void reloadSocketListener() {
        if (socket != null) {
            System.out.println("reloadSocketListener -> getDataVector");
            System.out.println("reloadSocketListener -> getDataVector");
            listenerDefaultModel.getDataVector().forEach(( vector) -> {
                System.out.println("reloadSocketListener -> hasListeners");
                System.out.println("reloadSocketListener -> toString");
                System.out.println("reloadSocketListener -> toString");
                System.out.println("reloadSocketListener -> toString");
                System.out.println("reloadSocketListener -> toString");
                System.out.println("reloadSocketListener -> toString");
                ...
                if (!socket.hasListeners(listener)) {
                    System.out.println("reloadSocketListener -> on");
                    socket.on(listener, ( args) -> {
                        System.out.println("reloadSocketListener -> concat");
                        System.out.println("reloadSocketListener -> concat");
                        System.out.println("reloadSocketListener -> concat");
                        System.out.println("reloadSocketListener -> append");
                        System.out.println("reloadSocketListener -> toString");
                        System.out.println("reloadSocketListener -> toString");
                        System.out.println("reloadSocketListener -> toString");
                        System.out.println("reloadSocketListener -> toString");
    ...
    public void deleteSelectedRowListener() {
        System.out.println("deleteSelectedRowListener -> getSelectedRow");
        if (!(listenerTable.getSelectedRow() < 0)) {
            System.out.println("deleteSelectedRowListener -> getSelectedRow");
            System.out.println("deleteSelectedRowListener -> removeRow");
            System.out.println("deleteSelectedRowListener -> getSelectedRow");
            System.out.println("deleteSelectedRowListener -> getValueAt");
            System.out.println("deleteSelectedRowListener -> getValueAt");
            ...
            if (socket != null) {
                System.out.println("deleteSelectedRowListener -> hasListeners");
                if (socket.hasListeners(deletedListener)) {
                    System.out.println("deleteSelectedRowListener -> off");
    ...
    public void setStatus(boolean status) {
        System.out.println("setStatus -> setEnabled");
        System.out.println("setStatus -> setEnabled");
        isConnected = status;
        emitButton.setEnabled(isConnected);
        // It always be true
        ...
        if (isConnected) {
            System.out.println("setStatus -> getButtonText");
            System.out.println("setStatus -> setText");
